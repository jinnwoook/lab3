...
from lib.datasets import Cifar10Labeled, CIFAR10_MEAN, CIFAR10_STD
from lib.models import ResNet
from lib.engines import train_one_epoch_supervised, eval_one_epoch
...
def get_args():
    ...
    parser.add_argument('--', default=1e-6, type=int)
...
def main(args):
    ...
    for epoch in range(args.epochs):
        # train one epoch
        train_summary = train_one_epoch_supervised(
            model, train_loader, metric_fn, loss_fn, args.device,
            optimizer, scheduler)
